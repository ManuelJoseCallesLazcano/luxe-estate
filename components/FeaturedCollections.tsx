    ...
    <section className="mb-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {featuredProperties.map((property) => (
          <div key={property.id} className="group relative rounded-xl overflow-hidden shadow-soft bg-white dark:bg-white/5 cursor-pointer">
            ...
            <div className={`p-6 ${property.id === 'f1' ? 'relative' : ''}`}>
